...
def nearest_unvisited_dead_end(currentRoom):
    ...
    while q.size() > 0:
        # dequeue exit
        path = q.dequeue()
        # Problem: how to check directions of room from directions given
        room = currentRoom
...
# Do bfs to find nearest path to unvisited dead-end
# Get neighbors
# Check if any are dead-ends
# Check if room is a dead-end

# Dead end is a room with only 1 direction
# Travel there and loop
# if no more dead-ends, travel to nearest unvisited room, loop
